...
## Self-check before shipping a description or skill edit

- [ ] Description states what the skill is and lists only genuinely distinct **branches**, one trigger per branch
- [ ] The skill's **leading word** is front-loaded and reused consistently through the body
- [ ] Every piece of **reference** sits at the right rung of the **information hierarchy** (in-skill step, in-skill reference, or disclosed/external reference)
- [ ] Each sentence survives the **no-op** test — it changes behaviour versus the model's default, or it's cut
- [ ] No **duplication**: the same meaning lives in exactly one **single source of truth**
- [ ] Failure-mode diagnosis (**premature completion**, **sediment**, **sprawl**, **negation**) applied to the reviewed text

**Completion gate:** this checklist is the stop condition for the review — do not treat a description rewrite or skill edit as complete until every box above is checked against the file's actual content, not against intent.
