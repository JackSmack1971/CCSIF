...
**Stop condition:** use the `blocked` disposition and stop further triage when required evidence is unavailable or permissions prevent inspection, instead of guessing a disposition.
