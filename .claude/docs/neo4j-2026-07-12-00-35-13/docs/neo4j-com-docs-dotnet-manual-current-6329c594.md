---
title: "Build applications with Neo4j and .NET"
source_url: "https://neo4j.com/docs/dotnet-manual/current/"
host: "neo4j.com"
depth: 1
selector: "article,main,[role=main]"
fetched_at: "2026-07-12T00:35:13.145Z"
---
[](https://neo4j.com/docs)

[Raise an issue](https://github.com/neo4j/docs-drivers/issues/new/?title=Docs%20Feedback%20dotnet-manual/modules/ROOT/pages/index.adoc%20\(ref:%206.x\)&body=%3E%20Do%20not%20include%20confidential%20information,%20personal%20data,%20sensitive%20data,%20or%20other%20regulated%20data.)
...
[More info on installing the driver](https://neo4j.com/docs/dotnet-manual/current/install/)

## [](https://neo4j.com/docs/dotnet-manual/current/#connect)Connect to the database

Connect to a database by creating an `IDriver` object and providing a URL and an authentication token. Once you have a `IDriver` instance, use the `.VerifyConnectivityAsync()` method to ensure that a working connection can be established.
...
[More info on connecting to a database](https://neo4j.com/docs/dotnet-manual/current/connect/)

## [](https://neo4j.com/docs/dotnet-manual/current/#create-graph)Create an example graph

Run a Cypher query with the method `IDriver.ExecutableQuery()`. Do not hardcode or concatenate parameters: use placeholders and specify the parameters as a map through the `.WithParameters()` method.
...
[More info on querying the database](https://neo4j.com/docs/dotnet-manual/current/query-simple/)

## [](https://neo4j.com/docs/dotnet-manual/current/#query-graph)Query a graph
...
## [](https://neo4j.com/docs/dotnet-manual/current/#close)Close connections and sessions
...
A [`IDriver`](https://neo4j.com/docs/api/dotnet-driver/current/api/Neo4j.Driver.IDriver.html) object holds the details required to establish connections with a Neo4j database.
