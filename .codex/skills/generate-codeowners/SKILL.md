...
description: Use when generating or auditing a GitHub CODEOWNERS file from verified repository evidence and GitHub ownership data. Trigger on generate CODEOWNERS, audit our CODEOWNERS file, redesign ownership mapping, fix a monorepo ownership routing problem. NOT for GitLab approval sections or Bitbucket-specific ownership syntax; use the platform's native tooling instead. Requires verified GitHub ownership data and never inventing unresolved GitHub handles.
