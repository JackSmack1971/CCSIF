...
**Stop condition:** do not report completion while the validator or `git diff --check` reports an error; fix and rerun until both are clean or state the exact unresolved blocker.
